...
def modelV1():
    ...
    # URL Google Drive file (link sharing)
    url = 'https://drive.google.com/uc?id=1XVy2wiHuPZ4ims74xA9vz1_GAsm6vmpu'
    output = 'modelv1.h5'
...
def modelV2():
    ...
    # URL Google Drive file (link sharing)
    url = 'https://drive.google.com/uc?id=1nudDB7lRE1ssRTQNgKJRCRcC9_MlHvMh'
    output = 'modelv2.h5'
